            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-white/20 backdrop-blur-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-6">
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#2E3A24] to-[#6B9071] text-creamy-white py-5 px-8 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-[#6B9071]/30 relative overflow-hidden group"
                  >
