  ...
  return (
    <section className="min-h-screen bg-white py-12 lg:py-20">
          ...
          <div className="flex items-center justify-center p-6 sm:p-8 lg:p-16 order-1 lg:order-2">
            <div className="max-w-lg space-y-6 lg:space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-base sm:text-lg text-[#2E3A24]/80 leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-[#6B9071] mb-2">15+</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs sm:text-sm text-[#2E3A24]/70">Emergency Service</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-[#6B9071] mb-2">100%</div>
                  <div className="text-xs sm:text-sm text-[#2E3A24]/70">Guaranteed Results</div>
                </div>
              </div>

              <div className="space-y-4">
                <h3 className="text-xl sm:text-2xl font-bold text-[#2E3A24]">Why Choose Us?</h3>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#A8B5A2] rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-[#2E3A24] text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <span className="text-sm sm:text-base text-[#2E3A24]/80">Licensed and Insured Professionals</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#A8B5A2] rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-[#2E3A24] text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <span className="text-sm sm:text-base text-[#2E3A24]/80">Eco-Friendly Treatment Methods</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#A8B5A2] rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-[#2E3A24] text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <span className="text-sm sm:text-base text-[#2E3A24]/80">Same-Day Emergency Response</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          {/* Left Side - Content */}
          <div className="flex items-center justify-center p-6 sm:p-8 lg:p-16 order-1">
            <div className="max-w-lg space-y-6 lg:space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2E3A24] leading-tight">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-[#F7F3E9] p-4 sm:p-6 rounded-xl">
                  <h4 className="text-lg sm:text-xl font-bold text-[#2E3A24] mb-2 sm:mb-3">Residential Services</h4>
                  <p className="text-sm sm:text-base text-[#2E3A24]/70">
                ...
                <div className="bg-[#F7F3E9] p-4 sm:p-6 rounded-xl">
                  <h4 className="text-lg sm:text-xl font-bold text-[#2E3A24] mb-2 sm:mb-3">Commercial Solutions</h4>
                  <p className="text-sm sm:text-base text-[#2E3A24]/70">
                ...
                <div className="bg-[#F7F3E9] p-4 sm:p-6 rounded-xl">
                  <h4 className="text-lg sm:text-xl font-bold text-[#2E3A24] mb-2 sm:mb-3">Emergency Response</h4>
                  <p className="text-sm sm:text-base text-[#2E3A24]/70">
          ...
          {/* Right Side - Image */}
          <div className="relative h-64 sm:h-80 md:h-96 lg:h-full order-2">
            <Image
              src="/About-2.jpg"
