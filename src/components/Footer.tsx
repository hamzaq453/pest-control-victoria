...
export default function Footer() {
  ...
  const services = [
    { name: "Pest Control Near Me", slug: "/pest-control-near-me" },
    { name: "Pest Control Cost", slug: "/pest-control-cost" },
    { name: "Eco-Friendly Pest Control", slug: "/eco-friendly-pest-control" },
    { name: "Fumigation Services", slug: "/fumigation-services" },
    { name: "Emergency Pest Control", slug: "same-day-emergency-services" }
  ];
          ...
          <div className="space-y-3 md:space-y-4 lg:space-y-6">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm break-all">info@pestfreevictoria.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-[#A8B5A2] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-[#6B9071]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-6">
          ...
          <div className="md:hidden space-y-2 text-center">
            <div className="text-xs text-creamy-white/70">
              © {currentYear} Pest Free Victoria. All rights reserved.
            </div>
            <div className="text-xs text-creamy-white/70 flex items-center justify-center gap-2">
              <Link href="/privacy" className="hover:text-[#A8B5A2] transition-colors duration-200">
                Privacy Policy
              </Link>
              <span className="text-[#6B9071]/50">•</span>
              <span>
                Powered by{" "}
          ...
          <div className="hidden md:grid md:grid-cols-3 items-center gap-4">
            {/* Copyright */}
            <div className="text-sm text-creamy-white/70 justify-self-start">
              © {currentYear} Pest Free Victoria. All rights reserved.
            </div>
